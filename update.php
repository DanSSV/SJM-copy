	...
	<div class="container">
		<form action="php/update.php" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="product" name="product" value="<?= $row['product'] ?>"
			...
			<div class="form-group">
				...
				<input type="date" class="form-control" id="expiration" name="expiration"
					value="<?= $row['expiration'] ?>" placeholder="Enter Expiration Date">
			</div>
			...
			<button type="button" class="btn btn-secondary" onclick="window.location.href='read.php'">Back</button>
		</form>
	</div>
</body>
